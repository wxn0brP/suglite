...
import { killHard, startProcess, stopProcess } from "./process.js";
import { appendFileSync, existsSync, readFileSync, writeFileSync } from "fs";
export const customCommandsProcess = new Map();
if (config.history && config.history > 0) {
    if (!existsSync(".suglite_history"))
        writeFileSync(".suglite_history", "");
}
...
function runCustomCommand(command, prettyLog = true) {
